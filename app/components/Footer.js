  ...
  return (
    <footer className="bg-dark-800 border-t border-dark-600">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-300">
                ...
                <a href="mailto:kontakt@example.com" className="hover:text-primary-400 transition-colors">
                  kontakt@example.com
                </a>
              </li>
              <li className="flex items-center text-gray-300">
            ...
            <div className="flex mt-4 space-x-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="Profil LinkedIn" className="text-gray-300 hover:text-primary-400 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="Profil GitHub" className="text-gray-300 hover:text-primary-400 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Profil Twitter" className="text-gray-300 hover:text-primary-400 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Copyright */}
        <div className="mt-8 pt-8 border-t border-dark-600 text-center text-gray-400 text-sm">
          <p>© {currentYear} Bartłomiej Boroski. Wszelkie prawa zastrzeżone.</p>
        </div>
      </div>
    </footer>
  );
